...
internal interface Converters {
    ...
    interface Database : BaseConverter<DatabaseParameters, OperationTask> {

        suspend infix fun get(parameters: DatabaseParameters.Get): OperationTask

        suspend infix fun import(parameters: DatabaseParameters.Import): OperationTask

        suspend infix fun rename(parameters: DatabaseParameters.Rename): OperationTask

        suspend infix fun command(parameters: DatabaseParameters.Command): OperationTask
    }
